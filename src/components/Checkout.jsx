...
export const Checkout = () => {
  ...
  return (
    <>
      ...
      autoComplete="off"
    >
      <TextField onInput={onAddName} id="nombre" label="nombre" variant="outlined" />
      <TextField onInput={onAddTelefono} id="telefono" label="telefono" variant="outlined" />
      <TextField onInput={onAddEmail} id="email" label="email" variant="outlined" />
